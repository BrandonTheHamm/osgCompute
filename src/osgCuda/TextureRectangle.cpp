...
namespace osgCuda
{
	...
	*/
	...
	void TextureRectangleBuffer::syncTexture( TextureStream& stream ) const
	{
		...
		if( !bufferExt )
		{
			osg::notify(osg::FATAL)
				<< "osgCuda::TextureRectangleBuffer::syncTexture(): cannot find required extension for context \""<<stream._context->getId()<<"\"."
				<< std::endl;
		...
		{
			osg::notify(osg::FATAL)
				<< "osgCuda::TextureRectangleBuffer::syncTexture(): texture object not allocated for context \""<<stream._context->getId()<<"\"."
				<< std::endl;
	...
	void TextureRectangleBuffer::syncPBO( TextureStream& stream ) const
	{
		...
		{
			osg::notify(osg::FATAL)
				<< "osgCuda::TextureRectangleBuffer::syncPBO(): cannot find required extension for context \""<<stream._context->getId()<<"\"."
				<< std::endl;
		...
		{
			osg::notify(osg::FATAL)
				<< "osgCuda::TextureRectangleBuffer::syncPBO() : texture object not allocated for context \""<<stream._context->getId()<<"\"."
				<< std::endl;
