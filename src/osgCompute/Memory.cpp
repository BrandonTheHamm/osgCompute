...
{   
    ...
    //------------------------------------------------------------------------------
    void Memory::releaseGLObjects( osg::State* state )
    {
        releaseObjectsLocal();
    ...
    //------------------------------------------------------------------------------
    void Memory::releaseObjectsLocal()
    {
        _object = NULL;
    }
    ...
    {
        releaseObjectsLocal();
        Memory::releaseObjects();
    }

    //------------------------------------------------------------------------------
    void GLMemory::releaseGLObjects( osg::State* state )
    {
        releaseObjectsLocal();
        Memory::releaseGLObjects(state);
    }
    ...
    //------------------------------------------------------------------------------
    void GLMemory::releaseObjectsLocal()
    {
    }
} 
